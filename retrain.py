...
parser.add_argument("-f", "--finetuned_epochs", type=int, required=True)
parser.add_argument("-e", "--retraining_epochs", type=int, required=True)
...
filename_tail = "_all_" + pruning_rate_underline + "_epoch" + str(args.finetuned_epochs) + "_epoch" + str(args.retraining_epochs)
...
MODULE_FINETUNED_FILE = "./numpy/modules_finetuned_all_" + pruning_rate_underline + "_epoch" + str(args.finetuned_epochs) + ".npy"
MODEL_BEST_PREFIX = "./model/retrained_all_" + pruning_rate_underline + "_epoch" + str(args.finetuned_epochs)
...
for epoch in range(1, NUM_EPOCHS+1):
    ...
    if BLEU_score > best_BLEU:
        ...
        best_epoch = epoch
        MODEL_BEST_FILE = MODEL_BEST_PREFIX + "_best.pth"
